...
<div className="aba-lateral"> {/*Começo da aba lateral*/} 
            ...
            <div className="opcoes"> {/*Começo das opções*/}
                <Link to={'/admin/home'} className="icone-opcoes"><img src="/image/silhueta-negra-de-casa-sem-porta 2.png" alt="opcao"/><a href='http://localhost:3000/admin/home' className="nome-icones">Home</a></Link> 
